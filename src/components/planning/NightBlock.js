...
const NightBlock = ({ tasks, onOptimize, optimizingRouteId, onTaskMouseEnter, onTaskMouseLeave }) => {
    const entregasNoturnas = tasks.filter(t => t.assignedTo === 'entregas_noturnas').sort((a,b) => a.orderInRoute - b.orderInRoute);

    return (
        <div className="flex h-full gap-4">
            <RouteColumn 
                routeId="entregas_noturnas" 
                name="Entregas Noite (Congonhas)" 
                tasks={entregasNoturnas} 
